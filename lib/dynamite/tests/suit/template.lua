...
local function test_fill_space(s, t)
    ...
    for _, c in ipairs(t:clients()) do
        ...
        assert(geo.x >= wa.x, "The layout `x` is out of bound "..geo.x.." "..wa.x.." "..s.geometry.x) --FIXME
        assert(geo.y >= wa.y, "The layout `y` is out of bound "..geo.y.." "..wa.y.." "..s.geometry.y) --FIXME
